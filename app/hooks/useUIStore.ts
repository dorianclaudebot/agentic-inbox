...
export const useUIStore = create<UIState>((set) => ({
  ...
  openSidebar: () => set({ isSidebarOpen: true, isAgentPanelOpen: false }),
  ...
  toggleSidebar: () =>
    set((state) => {
      ...
      return {
        isSidebarOpen,
        isAgentPanelOpen: isSidebarOpen ? false : state.isAgentPanelOpen,
      };
    }),
  ...
  toggleAgentPanel: () =>
    set((state) => {
      ...
      return {
        isAgentPanelOpen,
        isSidebarOpen: isAgentPanelOpen ? false : state.isSidebarOpen,
      };
    }),
