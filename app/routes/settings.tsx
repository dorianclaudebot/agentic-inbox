...
export default function SettingsRoute() {
  ...
  useEffect(() => {
    if (mailbox) {
      ...
      setAutoDraftReplies(mailbox.settings?.autoDraftReplies !== false);
    }
  }, [mailbox]);
    ...
    <div className="max-w-2xl px-4 py-4 md:px-8 md:py-6 h-full overflow-y-auto">
      ...
      <div className="space-y-6">
        ...
        <div className="rounded-lg border border-kumo-line bg-kumo-base p-5">
          ...
          <div className="mb-4">
            <Switch
              label="Automatically draft replies"
              checked={autoDraftReplies}
              onCheckedChange={setAutoDraftReplies}
              controlFirst
            />
            <p className="text-xs text-kumo-subtle mt-1.5">
              When on, the agent drafts a reply as soon as mail arrives. Turn this off and use Draft
              reply on the email toolbar instead.
            </p>
          </div>
          <textarea
            value={agentPrompt}
